...
description: Researches and writes ONE interview-prep file (company-brief.md, position-intro.md, 模擬面試-QA.md, or 基本知識.md) into an existing interview-prep/<Company>/<Position>/ folder. Spawned by the interview-prep skill, two at a time. Not for general research — it only writes the four file types that skill defines.
