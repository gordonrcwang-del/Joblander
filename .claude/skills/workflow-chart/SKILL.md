...
3. **Draw the flowchart** at this detail level (match `interview_prep/WORKFLOW.md` and `automation/job-apply/WORKFLOW.md` as reference implementations):
   ...
   - Use the real file/folder/config names from the skill (e.g. `applicant_profile.json`, `company_brief.md`) — these are not "too technical" to keep, they're the whole point of the "what gets touched" half of the doc.
